...
import './EEE.css'; // Import the CSS file for styling
...
function CS() {
  ...
  const semesters = Object.keys(data.eee); // ['semester 3', 'semester 4', ...]

  return (
    <div className="cs-container">
      {/* Main Title for Computer Science */}
      <h1 className="cs-title">Electrical and Electronics </h1>
