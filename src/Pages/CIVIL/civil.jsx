...
import './civil.css'; // Import the CSS file for styling
...
function CS() {
  ...
  const semesters = Object.keys(data.civil); // ['semester 3', 'semester 4', ...]

  return (
    <div className="cs-container">
      {/* Main Title for Computer Science */}
      <h1 className="cs-title">CIVIL </h1>
      ...
      <Pagemodal 
        sem={data['civil'][selectedSemester]} 
